...
public class UpdateRoom extends JFrame implements ActionListener {
	...
	public UpdateRoom(){
		...
		JLabel headline=new JLabel("Update Room");
		...
		table=new JTable();
		table.setBounds(20,150,650,250);
		add(table);
		...
		try {
			Conn c=new Conn();
			ResultSet rs=c.s.executeQuery("SELECT rooms.*, roomTypes.price FROM roomTypes JOIN rooms ON roomTypes.roomname = rooms.roomtype ORDER BY rooms.roomnumber");
